...
import time
from key import left_pressed, right_pressed, up_pressed
from key import PressKey, ReleaseKey

up_key_pressed= up_pressed
# down_key_pressed=down_pressedR
...
with mp_hand.Hands(min_detection_confidence=0.5, min_tracking_confidence=0.5) as hands:
    while True:
        ...
        if len(lmList)!=0:
            ...
            if total==0:
                cv2.putText(image, "BREAK", (440,460), cv2.FONT_HERSHEY_COMPLEX, 1, (255,255,255), 1, cv2.LINE_AA)
                ...
                cv2.putText(image, "GAS", (440,460), cv2.FONT_HERSHEY_COMPLEX, 1, (255,255,255), 1, cv2.LINE_AA)
                # cv2.putText(image, 'BRAKE', (45, 375), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 0), 5)
